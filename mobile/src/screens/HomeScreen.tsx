...
export default function HomeScreen() { // Acting as RoleSelectionScreen
            ...
            <View style={styles.content}>
                ...
                >
                    ...
                    <View style={styles.cardTextContainer}>
                        ...
                        <Text style={styles.cardDescription}>
                            Gerencie turmas, realize chamadas e acompanhe a frequência dos alunos.
                        </Text>
                    </View>
                ...
                >
                    ...
                    <View style={styles.cardTextContainer}>
                        ...
                        <Text style={styles.cardDescription}>
                            Registre sua presença, visualize seus horários e histórico de frequência.
                        </Text>
                    </View>
                    <MaterialIcons name="chevron-right" size={24} color="#CAC4D0" />
                </TouchableOpacity>
