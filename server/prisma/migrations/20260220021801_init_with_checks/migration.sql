...
-- AddCheckConstraint
ALTER TABLE "Course" ADD CONSTRAINT "Course_teacherRole_check" CHECK ("teacherRole" = 'TEACHER');

-- AddCheckConstraint
ALTER TABLE "StudentCourse" ADD CONSTRAINT "StudentCourse_studentRole_check" CHECK ("studentRole" = 'STUDENT');
